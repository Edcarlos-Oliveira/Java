...
public class ResolucaoTela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/MonitorR.png"))); // NOI18N

        jLabel2.setText("A Resolução da Tela é:");

        lblRt.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblRt.setText("Clique no Botão");

        btnRt.setForeground(new java.awt.Color(0, 0, 255));
        btnRt.setText("Clique Aqui");
    ...
    private void btnRtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRtActionPerformed
        ...
        lblRt.setText(+ d.width + " X " + d.height);
